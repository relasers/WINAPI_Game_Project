...
void CStageScene_2::Update_Scene()
{
	...
	if (m_PlayerPos.x < m_rcScene.right / SCENE_MOVE_PIVOT - 100)
	{
		...
		{
			// 카메라가 맵 시작점에 도달하지 않았을 경우 화면의 1/3지점에 유닛 고정
...
{
	m_Boss = new CBoss(TEXT("Resource\\Graphics\\Sprite\\보스.png"), m_pSound, 46, 26);
